...
// ShowFavorites 商品收藏夹
func (service *FavoritesService) ShowFavorites(ctx context.Context, uId uint) serializer.Response {
	...
	return serializer.BuildListResponse(serializer.BuildListFavorites(ctx, favorites), uint(total))
}

// CreateFavorites 创建收藏夹
func (service *FavoritesService) CreateFavorites(ctx context.Context, uId uint) serializer.Response {
	code := e.SUCCESS
...
func (service *FavoritesService) DeleteFavorites(ctx context.Context) serializer.Response {
	code := e.SUCCESS
